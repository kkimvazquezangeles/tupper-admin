...
<html>
    ...
    <body>
        ...
        <div id="edit-producto" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${this.producto}">
            <ul class="errors" role="alert">
                <g:eachError bean="${this.producto}" var="error">
                <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                </g:eachError>
            </ul>
            </g:hasErrors>
            <g:form resource="${this.producto}" method="PUT">
                <g:hiddenField name="version" value="${this.producto?.version}" />
                <fieldset class="form">
                    <f:all bean="producto"/>
                </fieldset>
