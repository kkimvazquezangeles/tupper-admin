...
<html>
    ...
    <body>
        ...
        <div id="show-producto" class="content scaffold-show" role="main">
            ...
            <g:form resource="${this.producto}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.producto}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
